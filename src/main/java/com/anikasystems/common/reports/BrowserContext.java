...
/**
 * Framework level reusable methods to set and get the details to use them in Reports - browsername, browser version, platform, application name
 * @author CignitiTeam
 *
 */
public class BrowserContext {
	 ...
	 * @param platform
	 */
	private BrowserContext(String browserName, String version, String platform, String appName) {
	...
	public void setPlatform(String platform) {
		this.platform = platform;
		LOG.debug("BrowserContext Object Set With platform ( " + this.platform + " ) ");
	}
	...
	public void setApplicationName(String appName) {
		this.applicationName = appName;
		LOG.debug("BrowserContext Object Set With application name ( " + this.applicationName + " ) ");
	}
	...
	public String getApplicationName() {
		LOG.debug("Being returned : " + this.applicationName);
	 ...
	 */
	public synchronized static BrowserContext getBrowserContext(String browserName, String version, String platform, String applicationName) {
		BrowserContext browserContext = new BrowserContext(browserName, version, platform, applicationName);
